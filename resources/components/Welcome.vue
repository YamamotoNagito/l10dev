...
<template>
  <v-container>
    ...
    <v-row>
      <v-col cols="5">
        <!-- 画像ガビガビなのでもっといいやつに換えといてくれ -->
        <img src="../assets/img/detail_info_rader2.png" width="170%" height="170%" />
      </v-col>
      <v-col cols="7" class="welcome-wrapper">
        <div>
          <p class="text-h1">評価がグラフでわかる！</p>
          <p class="text-h2">
            <br />
            ・単位取得のしやすさ<br />
            ・スキルが身につくか<br />
    ...
    <v-row>
      <v-col cols="5" class="welcome-wrapper">
