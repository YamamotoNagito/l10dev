<template>
  <v-container>
    ...
    <p>
      　この利用規約（以下，「本規約」といいます。）は，かえで製作委員会（以下，「当団体」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
    </p>
    <br />
    ...
    <ol class="custom-ordered-list">
      ...
      <li>
        <p>当団体のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為</p>
      </li>
      <li>
        <p>
      ...
      <li>
        ...
        <ol class="custom-ordered-list">
          <li>
            <p>営業，宣伝，広告，勧誘，その他営利を目的とする行為（当団体の認めたものを除きます。）</p>
          </li>
          <li><p>性行為やわいせつな行為を目的とする行為</p></li>
          <li><p>面識のない異性との出会いや交際を目的とする行為</p></li>
          <li><p>他のユーザーに対する嫌がらせや誹謗中傷を目的とする行為</p></li>
          <li>
            <p>当団体，本サービスの他のユーザー，または第三者に不利益，損害または不快感を与えることを目的とする行為</p>
          </li>
          <li>
            <p>
              その他本サービスが予定している利用目的と異なる目的で本サービスを利用する行為宗教活動または宗教団体への勧誘行為その他，当団体が不適切と判断する行為
            </p>
          </li>
        </ol>
      </li>
    ...
    <ol class="custom-ordered-list">
      ...
      <li>
        <p>
          前項各号のいずれかに該当した場合，ユーザーは，当然に団体に対する一切の債務について期限の利益を失い，その時点において負担する一切の債務を直ちに一括して弁済しなければなりません。
        </p>
      </li>
      <li>
    ...
    <ol class="custom-ordered-list">
      ...
      <li>
        <p>本サービスに関して紛争が生じた場合には，当団体の拠点所在地を管轄する裁判所を専属的合意管轄とします。</p>
      </li>
    </ol>
    <br />
    <p class="over">以上</p>
